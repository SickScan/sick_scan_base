...
#include "API/Skeleton/Lidar1d/OLM100/OLM100_V002_004_000/include/OLM100_Variables.h"
#include <sstream>
...
PositionData_OLM100_Var::PositionData_OLM100_Var()
	: OLM100_Var("PositionData","PositionData",5,READ_ONLY,LEVEL_INVALID,LEVEL_INVALID,0)
{
}
...
Acceleration_OLM100_Var::Acceleration_OLM100_Var()
	: OLM100_Var("Acceleration","Acceleration",12,READ_ONLY,LEVEL_INVALID,LEVEL_INVALID,3)
{
}
...
GeneralReadability_OLM100_Var::GeneralReadability_OLM100_Var()
	: OLM100_Var("GeneralReadability","GeneralReadability",38,READ_ONLY,LEVEL_RUN,LEVEL_INVALID,36)
{
}
...
LocalReadability_OLM100_Var::LocalReadability_OLM100_Var()
	: OLM100_Var("LocalReadability","LocalReadability",39,READ_ONLY,LEVEL_RUN,LEVEL_INVALID,37)
{
}
...
Temperature_OLM100_Var::Temperature_OLM100_Var()
	: OLM100_Var("Temperature","Temperature",36,READ_ONLY,LEVEL_RUN,LEVEL_INVALID,34)
{
}
