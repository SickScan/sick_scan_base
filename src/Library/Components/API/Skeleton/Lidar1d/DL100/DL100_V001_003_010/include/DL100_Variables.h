...
#include <stdint.h>
#include <cstring>
#include "API/Skeleton/Lidar1d/DL100/DL100_V001_003_010/include/DL100_Types.h"
#include "Base/Core/Sensor/include/Common/SensorVariable.h"
#include "API/Skeleton/Lidar1d/DL100/DL100_V001_003_010/include/DL100_CoLa_Extension.h"

namespace ssbl
{
namespace DL100_V001_003_010_Skeleton
{
template <class T>
...
public:
	distance_DL100_Var();
	~distance_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<distance_DL100_Var>(*this); }
...
public:
	velocity_DL100_Var();
	~velocity_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<velocity_DL100_Var>(*this); }
...
public:
	...
	~averagedVelocity_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<averagedVelocity_DL100_Var>(*this); }
...
public:
	...
	~acceleration_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<acceleration_DL100_Var>(*this); }
...
public:
	...
	~dbLevelComm_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<dbLevelComm_DL100_Var>(*this); }
...
public:
	...
	~temperature_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<temperature_DL100_Var>(*this); }
...
public:
	...
	~distanceOffset_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<distanceOffset_DL100_Var>(*this); }
...
public:
	...
	~laserError_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<laserError_DL100_Var>(*this); }
...
public:
	...
	~temperatureError_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<temperatureError_DL100_Var>(*this); }
...
public:
	...
	~levelError_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<levelError_DL100_Var>(*this); }
...
public:
	...
	~plausiblityError_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<plausiblityError_DL100_Var>(*this); }
...
public:
	...
	~laserPrefailWarning_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<laserPrefailWarning_DL100_Var>(*this); }
...
public:
	...
	~temperaturePrefailWarning_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<temperaturePrefailWarning_DL100_Var>(*this); }
...
public:
	...
	~levelPrefailWarning_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<levelPrefailWarning_DL100_Var>(*this); }
...
public:
	...
	~plausiblityPrefailWarning_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<plausiblityPrefailWarning_DL100_Var>(*this); }
...
public:
	...
	~operatingHours_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<operatingHours_DL100_Var>(*this); }
...
public:
	...
	~mf1switchCounter_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<mf1switchCounter_DL100_Var>(*this); }
...
public:
	...
	~mf2switchCounter_DL100_Var(){};
	virtual std::unique_ptr<ComObj> Clone() const override { return ssbl::make_unique<mf2switchCounter_DL100_Var>(*this); }
