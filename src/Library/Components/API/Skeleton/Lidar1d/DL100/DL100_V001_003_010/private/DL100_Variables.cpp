...
averagedVelocity_DL100_Var::averagedVelocity_DL100_Var()
	: DL100_Var("averagedVelocity","velAv",185,READ_ONLY,LEVEL_RUN,LEVEL_INVALID,-1)
{
}
...
distanceOffset_DL100_Var::distanceOffset_DL100_Var()
	: DL100_Var("distanceOffset","distO",330,READ_WRITE,LEVEL_RUN,LEVEL_RUN,5)
{
}
...
mf1switchCounter_DL100_Var::mf1switchCounter_DL100_Var()
	: DL100_Var("mf1switchCounter","mf1Sc",348,READ_WRITE,LEVEL_RUN,LEVEL_RUN,20)
{
}
...
mf2switchCounter_DL100_Var::mf2switchCounter_DL100_Var()
	: DL100_Var("mf2switchCounter","mf2Sc",359,READ_WRITE,LEVEL_RUN,LEVEL_RUN,31)
{
}
