...
{
template <class T>
class TiM581Skeleton_Var : public SickSensorVariable
{
public:
	TiM581Skeleton_Var(		std::string name,
		std::string comName,
		uint16_t idx,
	...
	uint32_t SerializeContent(Serializer * pSer, uint8_t * pDest, uint32_t * pOffset)
	{
		...
		{
		case COLA_A:
			(reinterpret_cast<TiM581Skeleton_CoLaASerializer*> (pSer))->Serialize(pDest, this->Value_, pOffset);
			break;
		case COLA_B:
			(reinterpret_cast<TiM581Skeleton_CoLaBSerializer*> (pSer))->Serialize(pDest, this->Value_, pOffset);
			break;
		default:
			break;
		}
	...
	uint32_t DeserializeContent(Deserializer* pDes, uint8_t* pSrc)
	{
		...
		{
		case COLA_A:
			(reinterpret_cast<TiM581Skeleton_CoLaADeserializer*> (pDes))->Deserialize(pSrc, this->Value_, &offset);
			break;
		case COLA_B:
			(reinterpret_cast<TiM581Skeleton_CoLaBDeserializer*> (pDes))->Deserialize(pSrc, this->Value_, &offset);
			break;
		default:
			break;
		}
...
class ScanConfig_TiM581Skeleton_Var : public TiM581Skeleton_Var<ScanConfig_t>
{
public:
	ScanConfig_TiM581Skeleton_Var();
	~ScanConfig_TiM581Skeleton_Var(){};
	ComObj* Clone() { return new ScanConfig_TiM581Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new ScanConfig_TiM581Skeleton_Var; }
...
class EtherHostCoLaDialect_TiM581Skeleton_Var : public TiM581Skeleton_Var<Enum8_t>
{
public:
	EtherHostCoLaDialect_TiM581Skeleton_Var();
	~EtherHostCoLaDialect_TiM581Skeleton_Var(){};
	ComObj* Clone() { return new EtherHostCoLaDialect_TiM581Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new EtherHostCoLaDialect_TiM581Skeleton_Var; }
	SensorResult GetBasic(int8_t& value);
	SensorResult GetBasic(int16_t& value);
	SensorResult GetBasic(int32_t& value);
	SensorResult GetBasic(int64_t& value);
...
class DataOutputRange_TiM581Skeleton_Var : public TiM581Skeleton_Var<DataOutputRange_t>
{
public:
	DataOutputRange_TiM581Skeleton_Var();
	~DataOutputRange_TiM581Skeleton_Var(){};
	ComObj* Clone() { return new DataOutputRange_TiM581Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new DataOutputRange_TiM581Skeleton_Var; }
	SensorResult GetBasic(int8_t& value);
	SensorResult GetBasic(int16_t& value);
	SensorResult GetBasic(int32_t& value);
	SensorResult GetBasic(int64_t& value);
...
class ScanData_TiM581Skeleton_Var : public TiM581Skeleton_Var<ScanData_t>
{
public:
	ScanData_TiM581Skeleton_Var();
	~ScanData_TiM581Skeleton_Var(){};
	ComObj* Clone() { return new ScanData_TiM581Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new ScanData_TiM581Skeleton_Var; }
	SensorResult GetBasic(int8_t& value);
	SensorResult GetBasic(int16_t& value);
	SensorResult GetBasic(int32_t& value);
	SensorResult GetBasic(int64_t& value);
...
class ScanDataConfig_TiM581Skeleton_Var : public TiM581Skeleton_Var<ScanDataConfig_t>
{
public:
	ScanDataConfig_TiM581Skeleton_Var();
	~ScanDataConfig_TiM581Skeleton_Var(){};
	ComObj* Clone() { return new ScanDataConfig_TiM581Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new ScanDataConfig_TiM581Skeleton_Var; }
	SensorResult GetBasic(int8_t& value);
	SensorResult GetBasic(int16_t& value);
	SensorResult GetBasic(int32_t& value);
	SensorResult GetBasic(int64_t& value);
...
class SCdevicestate_TiM581Skeleton_Var : public TiM581Skeleton_Var<Enum8_t>
{
public:
	SCdevicestate_TiM581Skeleton_Var();
	~SCdevicestate_TiM581Skeleton_Var(){};
	ComObj* Clone() { return new SCdevicestate_TiM581Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new SCdevicestate_TiM581Skeleton_Var; }
	SensorResult GetBasic(int8_t& value);
	SensorResult GetBasic(int16_t& value);
	SensorResult GetBasic(int32_t& value);
	SensorResult GetBasic(int64_t& value);
...
class OrderNumber_TiM581Skeleton_Var : public TiM581Skeleton_Var<FixString7>
{
public:
	OrderNumber_TiM581Skeleton_Var();
	~OrderNumber_TiM581Skeleton_Var(){};
	ComObj* Clone() { return new OrderNumber_TiM581Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new OrderNumber_TiM581Skeleton_Var; }
	SensorResult GetBasic(int8_t& value);
	SensorResult GetBasic(int16_t& value);
	SensorResult GetBasic(int32_t& value);
	SensorResult GetBasic(int64_t& value);
