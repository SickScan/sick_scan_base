...
{
template <class T>
class TiM5xx_1_0_0Skeleton_Var : public SickSensorVariable
{
public:
	TiM5xx_1_0_0Skeleton_Var(		std::string name,
		std::string comName,
		uint16_t idx,
	...
	~TiM5xx_1_0_0Skeleton_Var(){};
	uint32_t SerializeContent(Serializer * pSer, uint8_t * pDest, uint32_t * pOffset)
	{
		switch (pSer->GetProtocolType())
		{
		case COLA_A:
			(reinterpret_cast<TiM5xx_1_0_0Skeleton_CoLaASerializer*> (pSer))->Serialize(pDest, this->Value_, pOffset);
			break;
		case COLA_B:
			(reinterpret_cast<TiM5xx_1_0_0Skeleton_CoLaBSerializer*> (pSer))->Serialize(pDest, this->Value_, pOffset);
			break;
		default:
			break;
		}
	...
	uint32_t DeserializeContent(Deserializer* pDes, uint8_t* pSrc)
	{
		...
		{
		case COLA_A:
			(reinterpret_cast<TiM5xx_1_0_0Skeleton_CoLaADeserializer*> (pDes))->Deserialize(pSrc, this->Value_, &offset);
			break;
		case COLA_B:
			(reinterpret_cast<TiM5xx_1_0_0Skeleton_CoLaBDeserializer*> (pDes))->Deserialize(pSrc, this->Value_, &offset);
			break;
		default:
			break;
		}
...
class ScanConfig_TiM5xx_1_0_0Skeleton_Var : public TiM5xx_1_0_0Skeleton_Var<ScanConfig_t>
{
public:
	ScanConfig_TiM5xx_1_0_0Skeleton_Var();
	~ScanConfig_TiM5xx_1_0_0Skeleton_Var(){};
	ComObj* Clone() { return new ScanConfig_TiM5xx_1_0_0Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new ScanConfig_TiM5xx_1_0_0Skeleton_Var; }
...
class EtherHostCoLaDialect_TiM5xx_1_0_0Skeleton_Var : public TiM5xx_1_0_0Skeleton_Var<Enum8_t>
{
public:
	EtherHostCoLaDialect_TiM5xx_1_0_0Skeleton_Var();
	~EtherHostCoLaDialect_TiM5xx_1_0_0Skeleton_Var(){};
	ComObj* Clone() { return new EtherHostCoLaDialect_TiM5xx_1_0_0Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new EtherHostCoLaDialect_TiM5xx_1_0_0Skeleton_Var; }
	SensorResult GetBasic(int8_t& value);
	SensorResult GetBasic(int16_t& value);
	SensorResult GetBasic(int32_t& value);
	SensorResult GetBasic(int64_t& value);
...
class DataOutputRange_TiM5xx_1_0_0Skeleton_Var : public TiM5xx_1_0_0Skeleton_Var<DataOutputRange_t>
{
public:
	DataOutputRange_TiM5xx_1_0_0Skeleton_Var();
	~DataOutputRange_TiM5xx_1_0_0Skeleton_Var(){};
	ComObj* Clone() { return new DataOutputRange_TiM5xx_1_0_0Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new DataOutputRange_TiM5xx_1_0_0Skeleton_Var; }
	SensorResult GetBasic(int8_t& value);
	SensorResult GetBasic(int16_t& value);
	SensorResult GetBasic(int32_t& value);
	SensorResult GetBasic(int64_t& value);
...
class ScanData_TiM5xx_1_0_0Skeleton_Var : public TiM5xx_1_0_0Skeleton_Var<ScanData_t>
{
public:
	ScanData_TiM5xx_1_0_0Skeleton_Var();
	~ScanData_TiM5xx_1_0_0Skeleton_Var(){};
	ComObj* Clone() { return new ScanData_TiM5xx_1_0_0Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new ScanData_TiM5xx_1_0_0Skeleton_Var; }
	SensorResult GetBasic(int8_t& value);
	SensorResult GetBasic(int16_t& value);
	SensorResult GetBasic(int32_t& value);
	SensorResult GetBasic(int64_t& value);
...
class ScanDataConfig_TiM5xx_1_0_0Skeleton_Var : public TiM5xx_1_0_0Skeleton_Var<ScanDataConfig_t>
{
public:
	ScanDataConfig_TiM5xx_1_0_0Skeleton_Var();
	~ScanDataConfig_TiM5xx_1_0_0Skeleton_Var(){};
	ComObj* Clone() { return new ScanDataConfig_TiM5xx_1_0_0Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new ScanDataConfig_TiM5xx_1_0_0Skeleton_Var; }
	SensorResult GetBasic(int8_t& value);
	SensorResult GetBasic(int16_t& value);
	SensorResult GetBasic(int32_t& value);
	SensorResult GetBasic(int64_t& value);
...
class SCdevicestate_TiM5xx_1_0_0Skeleton_Var : public TiM5xx_1_0_0Skeleton_Var<Enum8_t>
{
public:
	SCdevicestate_TiM5xx_1_0_0Skeleton_Var();
	~SCdevicestate_TiM5xx_1_0_0Skeleton_Var(){};
	ComObj* Clone() { return new SCdevicestate_TiM5xx_1_0_0Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new SCdevicestate_TiM5xx_1_0_0Skeleton_Var; }
	SensorResult GetBasic(int8_t& value);
	SensorResult GetBasic(int16_t& value);
	SensorResult GetBasic(int32_t& value);
	SensorResult GetBasic(int64_t& value);
...
class OrderNumber_TiM5xx_1_0_0Skeleton_Var : public TiM5xx_1_0_0Skeleton_Var<FixString7>
{
public:
	OrderNumber_TiM5xx_1_0_0Skeleton_Var();
	~OrderNumber_TiM5xx_1_0_0Skeleton_Var(){};
	ComObj* Clone() { return new OrderNumber_TiM5xx_1_0_0Skeleton_Var(*this); }
	static SickSensorVariable* Create() { return new OrderNumber_TiM5xx_1_0_0Skeleton_Var; }
	SensorResult GetBasic(int8_t& value);
	SensorResult GetBasic(int16_t& value);
	SensorResult GetBasic(int32_t& value);
	SensorResult GetBasic(int64_t& value);
