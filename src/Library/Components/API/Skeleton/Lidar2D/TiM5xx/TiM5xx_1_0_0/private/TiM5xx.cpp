...
TiM5xx::TiM5xx(const std::string& Ip, const std::string& interfaceName,
  ...
  AvailableSensorInterfaces_.push_back(
      ssbl::make_unique<SensorInterfaceDescription*>(
          new SensorInterfaceDescription("CoLaA Port", ETHERNET_INTERFACE,
                                         COLA_A, BY_NAME, 2111, {})));
  AvailableSensorInterfaces_.push_back(
      ssbl::make_unique<SensorInterfaceDescription*>(
          new SensorInterfaceDescription(
  ...
  AvailableSensorInterfaces_.push_back(
      ssbl::make_unique<SensorInterfaceDescription*>(
          new SensorInterfaceDescription(
              ...
              {std::make_tuple(COLA_B, "EtherHostCoLaDialect", "1"),
               std::make_tuple(COLA_A, "EtherHostCoLaDialect", "0")})));
  VariableRepo.RegisterComObj("TiM5xxScanConfig",
                              ScanConfig_TiM5xx_Var::Create);
  VariableRepo.RegisterComObj("TiM5xxEtherHostCoLaDialect",
                              EtherHostCoLaDialect_TiM5xx_Var::Create);
  VariableRepo.RegisterComObj("TiM5xxDataOutputRange",
                              DataOutputRange_TiM5xx_Var::Create);
  VariableRepo.RegisterComObj("TiM5xxScanData", ScanData_TiM5xx_Var::Create);
  VariableRepo.RegisterComObj("TiM5xxScanDataConfig",
                              ScanDataConfig_TiM5xx_Var::Create);
  VariableRepo.RegisterComObj("TiM5xxSCdevicestate",
                              SCdevicestate_TiM5xx_Var::Create);
  VariableRepo.RegisterComObj("TiM5xxOrderNumber",
                              OrderNumber_TiM5xx_Var::Create);
  FunctionRepo.RegisterComObj("TiM5xxSetScanConfig",
                              SetScanConfig_TiM5xx_Func::Create);
  FunctionRepo.RegisterComObj("TiM5xxmStartMeasure",
                              mStartMeasure_TiM5xx_Func::Create);
  FunctionRepo.RegisterComObj("TiM5xxmStopMeasure",
                              mStopMeasure_TiM5xx_Func::Create);
  FunctionRepo.RegisterComObj("TiM5xxmSetDateTime",
                              mSetDateTime_TiM5xx_Func::Create);
  FunctionRepo.RegisterComObj("TiM5xxRun", Run_TiM5xx_Func::Create);
  FunctionRepo.RegisterComObj("TiM5xxWriteEeprom",
                              WriteEeprom_TiM5xx_Func::Create);
  FunctionRepo.RegisterComObj("TiM5xxRebootDevice",
                              RebootDevice_TiM5xx_Func::Create);
  FunctionRepo.RegisterComObj("TiM5xxLoadFactoryDefaults",
                              LoadFactoryDefaults_TiM5xx_Func::Create);
  FunctionRepo.RegisterComObj("TiM5xxLoadApplicationDefaults",
                              LoadApplicationDefaults_TiM5xx_Func::Create);
...
Protocol* TiM5xx::DeviceSpecificProtocolInit(ProtocolType Protocol,
                                             AddressingMode AddrMode) {
  ssbl::Protocol* pRet = NULL;
  switch (Protocol) {
    case COLA_A:
      pRet = new TiM5xx_CoLaAProtocol(AddrMode, max_tx_buffer_size_,
                                      max_rx_buffer_size_);
      break;
    case COLA_B:
      pRet = new TiM5xx_CoLaBProtocol(AddrMode, max_tx_buffer_size_,
                                      max_rx_buffer_size_);
      break;
    default:
