...
ScanConfig_TiM5xx_Var::ScanConfig_TiM5xx_Var()
    : TiM5xx_Var("ScanConfig", "LMPscancfg", 215, READ_WRITE, LEVEL_RUN,
                 LEVEL_INVALID, 85) {}

SensorResult ScanConfig_TiM5xx_Var::GetBasicElement(
...
SensorResult ScanConfig_TiM5xx_Var::SetBasicElement(
    const std::string& elementName, int8_t& value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
  SSBL_UNUSED(elementName);
  SSBL_UNUSED(value);
...
EtherHostCoLaDialect_TiM5xx_Var::EtherHostCoLaDialect_TiM5xx_Var()
    : TiM5xx_Var("EtherHostCoLaDialect", "EIHstCola", 110, READ_WRITE,
                 LEVEL_RUN, LEVEL_AUTHORIZED_CLIENT, -1) {}

SensorResult EtherHostCoLaDialect_TiM5xx_Var::GetBasicElement(
    const std::string& elementName, int8_t& value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
  SSBL_UNUSED(elementName);
  SSBL_UNUSED(value);
...
SensorResult EtherHostCoLaDialect_TiM5xx_Var::SetBasicElement(
    const std::string& elementName, int8_t& value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
  SSBL_UNUSED(elementName);
  SSBL_UNUSED(value);
...
SensorResult EtherHostCoLaDialect_TiM5xx_Var::SetBasicFromString(
    std::string value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
...
DataOutputRange_TiM5xx_Var::DataOutputRange_TiM5xx_Var()
    : TiM5xx_Var("DataOutputRange", "LMPoutputRange", 217, READ_WRITE,
                 LEVEL_RUN, LEVEL_AUTHORIZED_CLIENT, 87) {}

SensorResult DataOutputRange_TiM5xx_Var::GetBasicElement(
    const std::string& elementName, int8_t& value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
  SSBL_UNUSED(elementName);
  SSBL_UNUSED(value);
...
SensorResult DataOutputRange_TiM5xx_Var::SetBasicElement(
    const std::string& elementName, int8_t& value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
  SSBL_UNUSED(elementName);
  SSBL_UNUSED(value);
...
ScanData_TiM5xx_Var::ScanData_TiM5xx_Var()
    : TiM5xx_Var("ScanData", "LMDscandata", 230, READ_ONLY, LEVEL_RUN,
                 LEVEL_INVALID, 90) {}

SensorResult ScanData_TiM5xx_Var::GetBasicElement(
    const std::string& elementName, int8_t& value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
  SSBL_UNUSED(elementName);
  SSBL_UNUSED(value);
...
SensorResult ScanData_TiM5xx_Var::SetBasicElement(
    const std::string& elementName, int8_t& value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
  SSBL_UNUSED(elementName);
  SSBL_UNUSED(value);
...
ScanDataConfig_TiM5xx_Var::ScanDataConfig_TiM5xx_Var()
    : TiM5xx_Var("ScanDataConfig", "LMDscandatacfg", 212, READ_WRITE, LEVEL_RUN,
                 LEVEL_AUTHORIZED_CLIENT, -1) {}

SensorResult ScanDataConfig_TiM5xx_Var::GetBasicElement(
    const std::string& elementName, int8_t& value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
  SSBL_UNUSED(elementName);
  SSBL_UNUSED(value);
...
SensorResult ScanDataConfig_TiM5xx_Var::SetBasicElement(
    const std::string& elementName, int8_t& value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
  SSBL_UNUSED(elementName);
  SSBL_UNUSED(value);
...
SCdevicestate_TiM5xx_Var::SCdevicestate_TiM5xx_Var()
    : TiM5xx_Var("SCdevicestate", "SCdevicestate", 10, READ_ONLY, LEVEL_RUN,
                 LEVEL_INVALID, 1) {}

SensorResult SCdevicestate_TiM5xx_Var::GetBasicElement(
    const std::string& elementName, int8_t& value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
  SSBL_UNUSED(elementName);
  SSBL_UNUSED(value);
...
SensorResult SCdevicestate_TiM5xx_Var::SetBasicElement(
    const std::string& elementName, int8_t& value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
  SSBL_UNUSED(elementName);
  SSBL_UNUSED(value);
...
OrderNumber_TiM5xx_Var::OrderNumber_TiM5xx_Var()
    : TiM5xx_Var("OrderNumber", "DIornr", 371, READ_WRITE, LEVEL_RUN,
                 LEVEL_INVALID, -1) {}

SensorResult OrderNumber_TiM5xx_Var::GetBasicElement(
    const std::string& elementName, int8_t& value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
  SSBL_UNUSED(elementName);
  SSBL_UNUSED(value);
...
SensorResult OrderNumber_TiM5xx_Var::SetBasicElement(
    const std::string& elementName, int8_t& value) {
  SensorResult ret = SSBL_ERR_VARIABLE_ELEMENT_NOT_FOUND;
  SSBL_UNUSED(elementName);
  SSBL_UNUSED(value);
