...
public:
	...
	uint32_t SerializeContent(Serializer * pSer, uint8_t * pDest, uint32_t * pOffset)
	{
		...
		{
		case COLA_A:
			(reinterpret_cast<TiM5xx_1_0_0_Skeleton_CoLaASerializer*> (pSer))->Serialize(pDest, this->Value_, pOffset);
			break;
		case COLA_B:
			(reinterpret_cast<TiM5xx_1_0_0_Skeleton_CoLaBSerializer*> (pSer))->Serialize(pDest, this->Value_, pOffset);
			break;
		default:
			break;
		}
	...
	uint32_t DeserializeContent(Deserializer* pDes, uint8_t* pSrc)
	{
		...
		{
		case COLA_A:
			(reinterpret_cast<TiM5xx_1_0_0_Skeleton_CoLaADeserializer*> (pDes))->Deserialize(pSrc, this->Value_, &offset);
			break;
		case COLA_B:
			(reinterpret_cast<TiM5xx_1_0_0_Skeleton_CoLaBDeserializer*> (pDes))->Deserialize(pSrc, this->Value_, &offset);
			break;
		default:
			break;
		}
...
class ScanConfig_TiM5xx_1_0_0_Skeleton_Var : public TiM5xx_1_0_0_Skeleton_Var<ScanConfig_t>
{
public:
...
class EtherHostCoLaDialect_TiM5xx_1_0_0_Skeleton_Var : public TiM5xx_1_0_0_Skeleton_Var<Enum8_t>
{
public:
...
class DataOutputRange_TiM5xx_1_0_0_Skeleton_Var : public TiM5xx_1_0_0_Skeleton_Var<DataOutputRange_t>
{
public:
...
class ScanData_TiM5xx_1_0_0_Skeleton_Var : public TiM5xx_1_0_0_Skeleton_Var<ScanData_t>
{
public:
...
class ScanDataConfig_TiM5xx_1_0_0_Skeleton_Var : public TiM5xx_1_0_0_Skeleton_Var<ScanDataConfig_t>
{
public:
...
class SCdevicestate_TiM5xx_1_0_0_Skeleton_Var : public TiM5xx_1_0_0_Skeleton_Var<Enum8_t>
{
public:
...
class OrderNumber_TiM5xx_1_0_0_Skeleton_Var : public TiM5xx_1_0_0_Skeleton_Var<FixString7>
{
public:
