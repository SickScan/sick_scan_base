...
#include "API/Skeleton/include/TiM571Skeleton/TiM571Skeleton_CoLa_Extension.h"
...
{
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanRange_t_aRange_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanRange_t_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, DateTime_t_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanConfig_t_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, FixString5& rSrc, uint32_t* pOffset)
	{
		SerializeFixString(pDest, rSrc.Text,5, pOffset);
	}

	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, DataChannelHdr_t_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanConfig_aRange_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanRange_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanConfig_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, DataOutputRange_aRange_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, DataOutputRange_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, DeviceBlock_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, StatusBlock_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, MeasurementParam1Block_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanData_aEncoderBlock_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanData_aDataChannel16_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanData_aDataChannel8_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanData_aPositionBlock_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, FlexString16& rSrc, uint32_t* pOffset)
	{
		SerializeFlexString(pDest, rSrc.Text, rSrc.uiLength,16, pOffset);
	}

	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, FlexString128& rSrc, uint32_t* pOffset)
	{
		SerializeFlexString(pDest, rSrc.Text, rSrc.uiLength,128, pOffset);
	}

	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanData_aTimeBlock_struct_t& rSrc, uint32_t* pOffset)
	{

		Serialize(pDest, rSrc.DateTime , pOffset);
	}

	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, FixString4& rSrc, uint32_t* pOffset)
	{
		SerializeFixString(pDest, rSrc.Text,4, pOffset);
	}

	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanData_aEventBlock_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanData_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, RemDataConfig_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, ScanDataConfig_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, FixString7& rSrc, uint32_t* pOffset)
	{
		SerializeFixString(pDest, rSrc.Text,7, pOffset);
	}

	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, SetScanConfig_t& rSrc, uint32_t* pOffset)
	{

		Serialize(pDest, rSrc.ScanConfigParam , pOffset);
	}

	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, mStartMeasure_t& rSrc, uint32_t* pOffset)
	{

		CoLaASerializer::Serialize(pDest, rSrc.ErrorCode , pOffset);
	}

	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, mStopMeasure_t& rSrc, uint32_t* pOffset)
	{

		CoLaASerializer::Serialize(pDest, rSrc.ErrorCode , pOffset);
	}

	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, mSetDateTime_t& rSrc, uint32_t* pOffset)
	{

		Serialize(pDest, rSrc.DateTime , pOffset);
	}

	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, Run_t& rSrc, uint32_t* pOffset)
	{

		CoLaASerializer::Serialize(pDest, rSrc.success , pOffset);
	}

	void TiM571Skeleton_CoLaASerializer::Serialize(uint8_t* pDest, WriteEeprom_t& rSrc, uint32_t* pOffset)
	{
...
namespace DevTiM571Skeleton
{
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanRange_t_aRange_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanRange_t_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, DateTime_t_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanConfig_t_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, FixString5& rDest, uint32_t* pOffset)
	{
		DeserializeFixString(pSrc, &rDest.Text[0],5, pOffset);
	}

	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, DataChannelHdr_t_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanConfig_aRange_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanRange_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanConfig_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, DataOutputRange_aRange_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, DataOutputRange_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, DeviceBlock_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, StatusBlock_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, MeasurementParam1Block_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanData_aEncoderBlock_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanData_aDataChannel16_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanData_aDataChannel8_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanData_aPositionBlock_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, FlexString16& rDest, uint32_t* pOffset)
	{
		DeserializeFlexString(pSrc, &rDest.Text[0],&rDest.uiLength,16 , pOffset);
	}

	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, FlexString128& rDest, uint32_t* pOffset)
	{
		DeserializeFlexString(pSrc, &rDest.Text[0],&rDest.uiLength,128 , pOffset);
	}

	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanData_aTimeBlock_struct_t& rDest, uint32_t* pOffset)
	{

		Deserialize(pSrc, rDest.DateTime , pOffset);
	}

	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, FixString4& rDest, uint32_t* pOffset)
	{
		DeserializeFixString(pSrc, &rDest.Text[0],4, pOffset);
	}

	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanData_aEventBlock_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanData_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, RemDataConfig_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, ScanDataConfig_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, FixString7& rDest, uint32_t* pOffset)
	{
		DeserializeFixString(pSrc, &rDest.Text[0],7, pOffset);
	}

	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, SetScanConfig_t& rDest, uint32_t* pOffset)
	{

		Deserialize(pSrc, rDest.ScanConfigParam , pOffset);
	}

	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, mStartMeasure_t& rDest, uint32_t* pOffset)
	{

		CoLaADeserializer::Deserialize(pSrc, rDest.ErrorCode , pOffset);
	}

	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, mStopMeasure_t& rDest, uint32_t* pOffset)
	{

		CoLaADeserializer::Deserialize(pSrc, rDest.ErrorCode , pOffset);
	}

	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, mSetDateTime_t& rDest, uint32_t* pOffset)
	{

		Deserialize(pSrc, rDest.DateTime , pOffset);
	}

	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, Run_t& rDest, uint32_t* pOffset)
	{

		CoLaADeserializer::Deserialize(pSrc, rDest.success , pOffset);
	}

	void TiM571Skeleton_CoLaADeserializer::Deserialize(uint8_t* pSrc, WriteEeprom_t& rDest, uint32_t* pOffset)
	{
...
namespace DevTiM571Skeleton
{
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanRange_t_aRange_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanRange_t_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, DateTime_t_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanConfig_t_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, FixString5& rSrc, uint32_t* pOffset)
	{
		SerializeFixString(pDest, rSrc.Text,5, pOffset);
	}

	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, DataChannelHdr_t_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanConfig_aRange_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanRange_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanConfig_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, DataOutputRange_aRange_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, DataOutputRange_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, DeviceBlock_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, StatusBlock_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, MeasurementParam1Block_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanData_aEncoderBlock_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanData_aDataChannel16_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanData_aDataChannel8_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanData_aPositionBlock_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, FlexString16& rSrc, uint32_t* pOffset)
	{
		SerializeFlexString(pDest, rSrc.Text, rSrc.uiLength,16, pOffset);
	}

	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, FlexString128& rSrc, uint32_t* pOffset)
	{
		SerializeFlexString(pDest, rSrc.Text, rSrc.uiLength,128, pOffset);
	}

	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanData_aTimeBlock_struct_t& rSrc, uint32_t* pOffset)
	{

		Serialize(pDest, rSrc.DateTime , pOffset);
	}

	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, FixString4& rSrc, uint32_t* pOffset)
	{
		SerializeFixString(pDest, rSrc.Text,4, pOffset);
	}

	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanData_aEventBlock_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanData_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, RemDataConfig_struct_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, ScanDataConfig_t& rSrc, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, FixString7& rSrc, uint32_t* pOffset)
	{
		SerializeFixString(pDest, rSrc.Text,7, pOffset);
	}

	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, SetScanConfig_t& rSrc, uint32_t* pOffset)
	{

		Serialize(pDest, rSrc.ScanConfigParam , pOffset);
	}

	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, mStartMeasure_t& rSrc, uint32_t* pOffset)
	{

		CoLaBSerializer::Serialize(pDest, rSrc.ErrorCode , pOffset);
	}

	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, mStopMeasure_t& rSrc, uint32_t* pOffset)
	{

		CoLaBSerializer::Serialize(pDest, rSrc.ErrorCode , pOffset);
	}

	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, mSetDateTime_t& rSrc, uint32_t* pOffset)
	{

		Serialize(pDest, rSrc.DateTime , pOffset);
	}

	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, Run_t& rSrc, uint32_t* pOffset)
	{

		CoLaBSerializer::Serialize(pDest, rSrc.success , pOffset);
	}

	void TiM571Skeleton_CoLaBSerializer::Serialize(uint8_t* pDest, WriteEeprom_t& rSrc, uint32_t* pOffset)
	{
...
namespace DevTiM571Skeleton
{
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanRange_t_aRange_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanRange_t_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, DateTime_t_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanConfig_t_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, FixString5& rDest, uint32_t* pOffset)
	{
		DeserializeFixString(pSrc, &rDest.Text[0],5, pOffset);
	}

	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, DataChannelHdr_t_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanConfig_aRange_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanRange_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanConfig_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, DataOutputRange_aRange_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, DataOutputRange_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, DeviceBlock_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, StatusBlock_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, MeasurementParam1Block_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanData_aEncoderBlock_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanData_aDataChannel16_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanData_aDataChannel8_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanData_aPositionBlock_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, FlexString16& rDest, uint32_t* pOffset)
	{
		DeserializeFlexString(pSrc, &rDest.Text[0],&rDest.uiLength,16 , pOffset);
	}

	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, FlexString128& rDest, uint32_t* pOffset)
	{
		DeserializeFlexString(pSrc, &rDest.Text[0],&rDest.uiLength,128 , pOffset);
	}

	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanData_aTimeBlock_struct_t& rDest, uint32_t* pOffset)
	{

		Deserialize(pSrc, rDest.DateTime , pOffset);
	}

	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, FixString4& rDest, uint32_t* pOffset)
	{
		DeserializeFixString(pSrc, &rDest.Text[0],4, pOffset);
	}

	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanData_aEventBlock_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanData_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, RemDataConfig_struct_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, ScanDataConfig_t& rDest, uint32_t* pOffset)
	{
	...
	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, FixString7& rDest, uint32_t* pOffset)
	{
		DeserializeFixString(pSrc, &rDest.Text[0],7, pOffset);
	}

	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, SetScanConfig_t& rDest, uint32_t* pOffset)
	{

		Deserialize(pSrc, rDest.ScanConfigParam , pOffset);
	}

	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, mStartMeasure_t& rDest, uint32_t* pOffset)
	{

		CoLaBDeserializer::Deserialize(pSrc, rDest.ErrorCode , pOffset);
	}

	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, mStopMeasure_t& rDest, uint32_t* pOffset)
	{

		CoLaBDeserializer::Deserialize(pSrc, rDest.ErrorCode , pOffset);
	}

	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, mSetDateTime_t& rDest, uint32_t* pOffset)
	{

		Deserialize(pSrc, rDest.DateTime , pOffset);
	}

	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, Run_t& rDest, uint32_t* pOffset)
	{

		CoLaBDeserializer::Deserialize(pSrc, rDest.success , pOffset);
	}

	void TiM571Skeleton_CoLaBDeserializer::Deserialize(uint8_t* pSrc, WriteEeprom_t& rDest, uint32_t* pOffset)
	{
