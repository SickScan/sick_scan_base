...
public:
	...
	~DataOutputRange_TiM7x1_Var(){};
	ComObj* Clone() { return new DataOutputRange_TiM7x1_Var(*this); }
...
public:
	ScanData_TiM7x1_Var();
	~ScanData_TiM7x1_Var(){};
	ComObj* Clone() { return new ScanData_TiM7x1_Var(*this); }
...
public:
	...
	~EtherHostCoLaDialect_TiM7x1_Var(){};
	ComObj* Clone() { return new EtherHostCoLaDialect_TiM7x1_Var(*this); }
...
public:
	...
	~ScanConfig_TiM7x1_Var(){};
	ComObj* Clone() { return new ScanConfig_TiM7x1_Var(*this); }
...
public:
	...
	~ScanDataConfig_TiM7x1_Var(){};
	ComObj* Clone() { return new ScanDataConfig_TiM7x1_Var(*this); }
...
public:
	...
	~SCdevicestate_TiM7x1_Var(){};
	ComObj* Clone() { return new SCdevicestate_TiM7x1_Var(*this); }
...
public:
	...
	~OrderNumber_TiM7x1_Var(){};
	ComObj* Clone() { return new OrderNumber_TiM7x1_Var(*this); }
